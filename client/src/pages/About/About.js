      ...
      <div className="about">
        ...
        <div className="row">
            ...
            <div className="col s12 m8 aboutContent">
                ...
                <h5>The goal of The explore Project is to help users find a new kind of travel experience.
                ...
                <h5>The explore Project wants to help alleviate this problem by providing a new type of city 
                    ...
                    find a more authentic local experience to make your vacation even more memorable. 
                </h5>
                <h4>explore the world, travel like a local.</h4>
            </div>
            <div className="col m2 hide-on-small-only"></div>
        </div>    
    </div>
